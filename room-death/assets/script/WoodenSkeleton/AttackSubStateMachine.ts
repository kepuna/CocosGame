...
const BASE_URL = 'ui/woodenskeleton/attack'
export default class AttackSubStateMachine extends DirectionSubStateMachine {
    // constructor(fsm: StateMachine) {
    //     super(fsm)
    //     this.stateMachines.set(DIRECTION_ENUM.TOP, new State(fsm, `${BASE_URL}/top`, cc.WrapMode.Loop))
    //     this.stateMachines.set(DIRECTION_ENUM.BOTTOM, new State(fsm, `${BASE_URL}/bottom`, cc.WrapMode.Loop))
    //     this.stateMachines.set(DIRECTION_ENUM.LEFT, new State(fsm, `${BASE_URL}/left`, cc.WrapMode.Loop))
    //     this.stateMachines.set(DIRECTION_ENUM.RIGHT, new State(fsm, `${BASE_URL}/right`, cc.WrapMode.Loop))
    // }
